...
Otherwise the data structure is the same as for the [standard address](/docs/public-address/standard-address/#data-structure).
...
* `G` is the "base point"; this is simply a constant specific to [edwards25519](/docs/cryptography/asymmetric/edwards25519)
...
The subaddress #0 on the account #0 is the [standard address](/docs/public-address/standard-address).
...
The procedure is the same as for the [standard address](/docs/public-address/standard-address).

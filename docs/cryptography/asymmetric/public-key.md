...
Public key is deterministically derived from private key based on [edwards25519 curve](/docs/cryptography/asymmetric/edwards25519) with a little Monero-specific twist.
...
* P is a public key
* x is a private key
* G is a "base point"; this is simply a constant specific to [edwards25519](/docs/cryptography/asymmetric/edwards25519); this point lies on the elliptic curve
...
[Monero address](/docs/public-address/standard-address) is composed of public spend key and public view key.

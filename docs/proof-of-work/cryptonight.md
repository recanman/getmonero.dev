...
**Monero no longer uses CryptoNight or any variant. Monero changed its mining algorithm to [RandomX](/docs/proof-of-work/random-x) in November 2019.**
...
* CryptoNight hash is relatively expensive to verify. This poses a risk of DoS-ing nodes with incorrect proofs to process. See [strong asymmetry](/docs/proof-of-work/what-is-pow/#strong-asymmetry) requirement. 
